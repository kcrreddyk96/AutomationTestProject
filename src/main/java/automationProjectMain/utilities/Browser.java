package automationProjectMain.utilities;

import automationProjectMain.pageObjects.modules.LandingPage;
...
public class Browser {
    ...
    public WebDriver initializeTheBrowser() {
        ...
        try {
            FileInputStream fileInputStream = new FileInputStream(System.getProperty("user.dir") + "//src//main//java//automationProjectMain//configs//config.properties");
        ...
        pageURL = "C:\\Users\\KC - Reddy\\Desktop\\TestExam\\TestPages\\QE-index.html";
